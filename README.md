...
# Angular Dynamic Compile component, that turns a string into a compiled component v5.2.107-326  
...
[**P3X-ANGULAR-COMPILE**](https://pages.corifeus.com/angular-compile) Build v5.2.107-326 
