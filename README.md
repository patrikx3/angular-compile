...
# Angular Dynamic Compile component, that turns a string into a compiled component v5.2.120-332  
...
[**P3X-ANGULAR-COMPILE**](https://pages.corifeus.com/angular-compile) Build v5.2.120-332 
